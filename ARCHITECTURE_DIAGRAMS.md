...
- **Hackathon video**: Use Mermaid diagrams in presentation slides
- **Devfolio submission**: Include in README or project documentation
- **README / pitch deck**: Copy Mermaid code blocks directly into markdown

All diagrams use neutral colors and engineering-first language suitable for technical audiences.
